...
namespace NntpClientLib
{
    ...
    public sealed class NewsgroupStatistics
    {
        ...
        public NewsgroupStatistics(string groupName, long estimateCount, long firstArticleId, long lastArticleId)
        {
